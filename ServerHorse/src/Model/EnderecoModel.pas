...
begin
    ...
    try
      ...
      begin
        ...
        Params.Clear;
        SQL.Clear;
        SQL.Add('SELECT MAX(ENDERECO_ID) AS ENDERECO_ID FROM ENDERECO');
        ...
        ENDERECO_ID := FieldByName('ENDERECO_ID').AsInteger;
      end;
    ...
    begin
      ServerModelConnection.FConn.Rollback;
      erro := 'Erro ao cadastrar endereco: ' + ex.Message;
      Result := False;
    end;
...
begin
   ...
   try
     ...
     begin
       Active := False;
       SQL.Clear;
       SQL.Add('SELECT * FROM ENDERECO WHERE 1 = 1');


       if ENDERECO_ID > 0 then
       begin
         SQL.Add('AND ENDERECO_ID = :ENDERECO_ID');
         ParamByName('ENDERECO_ID').Value := ENDERECO_ID;
       end;

       if order_by = '' then
       begin
         SQL.Add('ORDER BY RUA');
       end
       else
       begin
     ...
     begin
         erro := 'Erro ao consultar endereco: ' + ex.Message;
         Result := nil;
     end;
